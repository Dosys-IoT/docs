...
| :--- | :--- | :--- |
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta** | **Martel Zevallos, Gabriel Aristóteles**<br>• **AV1:** Lideré el diseño arquitectónico del componente mobile en el Capítulo IV, definiendo los patrones iniciales alineados a los requerimientos del sistema.<br>• **TB1:** Asumí el liderazgo técnico del desarrollo de la aplicación móvil (Frontend Mobile), guiando al equipo en los estándares de consumo de servicios y dependencias.<br><br>**Oblitas Davila, Mariano Moises**<br>• **AV1:** Lideré el modelado de datos y el análisis técnico preliminar durante las fases de elicitación y especificación (Capítulos II y III).<br>• **TB1:** Ejercí la dirección del desarrollo del Backend de la solución, definiendo la arquitectura del servidor, configurando los entornos de desarrollo y asegurando la disponibilidad de las APIs para los fronts.<br><br>**Qqueso Rodriguez, Britney Delhy**<br>• **AV1:** Guié el proceso de Elicitación de Requerimientos (Capítulo II), seleccionando y aplicando las técnicas adecuadas para el levantamiento de información técnica.<br>• **TB1:** Lideré de forma autónoma el diseño, implementación y despliegue en producción de la primera versión del Landing Page, cumpliendo con el objetivo del hito.<br><br>**Ybañez Esquerre, Miguel Angel**<br>• **AV1:** Tomé la iniciativa en el diseño lógico de software, modelando los diagramas de componentes y los flujos lógicos en el Capítulo IV.<br>• **TB1:** Ejercí el rol de líder de desarrollo para el Frontend Web, estableciendo el *Source Code Style Guide* y coordinando el pipeline de despliegue de la aplicación web.<br><br>**Zúñiga Murillo, Diego Sebastián**<br>• **AV1:** Actué como Team Leader del proyecto, gestionando la consolidación del informe técnico y aplicando revisiones de calidad previo a la entrega de la AV1.<br>• **TB1:** Lideré la gestión de calidad y mejora continua, encargándome del levantamiento de observaciones de la AV1 y gestionando los cambios y actualizaciones del documento base. | **AV1:**<br>Implementamos un modelo de liderazgo distribuido basado en nuestras especialidades técnicas. En lugar de centralizar la toma de decisiones en un único rol, cada uno de nosotros asumió la dirección de capítulos críticos de investigación y diseño de software, lo que garantizó madurez metodológica y autonomía desde las fases iniciales del proyecto.<br><br>**TB1:**<br>Consolidamos nuestra dinámica de co-liderazgo al asumir la responsabilidad directa de cada vertical técnica del ecosistema (Backend, Web, Mobile, Landing y QA). Esto agilizó la resolución de bloqueos técnicos y facilitó la integración de los componentes de software sin necesidad de una supervisión vertical constante. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos.** | **Martel Zevallos, Gabriel Aristóteles**<br>• **AV1:** Colaboré activamente en la redacción de la introducción y el análisis de requisitos, garantizando que el alcance técnico contemplara las necesidades de la plataforma móvil.<br>• **TB1:** Participé en el Sprint Planning 1, estimé mis tareas para el Frontend Mobile en el backlog, colaboré estrechamente con el encargado de Backend para la integración de endpoints y recopilé las evidencias para el Sprint Review.<br><br>**Oblitas Davila, Mariano Moises**<br>• **AV1:** Participé en las sesiones grupales de lluvia de ideas para la delimitación del alcance funcional del sistema.<br>• **TB1:** Colaboré de manera inclusiva proporcionando documentación clara y contratos de API (Swagger/Postman) para que mis compañeros de Frontend Web y Mobile pudieran alcanzar sus metas de integración a tiempo.<br><br>**Qqueso Rodriguez, Britney Delhy**<br>• **AV1:** Contribuí en la especificación de requerimientos (Capítulo III), integrando el feedback constructivo del equipo para refinar los casos de uso.<br>• **TB1:** Planifiqué mis actividades dentro del Sprint Backlog 1 asociadas al Landing Page y colaboré en el diseño UI/UX transversal del producto en el Capítulo V.<br><br>**Ybañez Esquerre, Miguel Angel**<br>• **AV1:** Colaboré en el desarrollo de los diagramas arquitectónicos y de despliegue de la solución grupal.<br>• **TB1:** Integré colaborativamente mis avances en el repositorio común siguiendo el flujo de trabajo de Git establecido, apoyando el cumplimiento de las metas de despliegue en la nube para el Frontend Web.<br><br>**Zúñiga Murillo, Diego Sebastián**<br>• **AV1:** Organicé el cronograma inicial y la asignación equitativa de subtareas, promoviendo un entorno inclusivo donde se validaron las propuestas de todos.<br>• **TB1:** Coordiné la sesión de Sprint Planning 1 y estructuré la sección de *Collaboration Insights*, monitoreando las métricas de avance del equipo y ejecutando las mejoras del documento técnico. | **AV1:**<br>Establecimos los hitos iniciales del proyecto dividiendo la carga académica y de investigación de forma equitativa. Logramos un entorno inclusivo mediante sesiones de revisión cruzada, asegurando que los requerimientos de software iniciales reflejaran el consenso técnico de todo el equipo.<br><br>**TB1:**<br>Adoptamos el marco de trabajo Scrum de manera rigurosa (Sprint Planning, Sprint Backlog y revisiones periódicas), lo que nos permitió planificar y estimar tareas con mayor precisión. Esta disciplina ágil fue clave para mitigar la deuda técnica, subsanar las observaciones de la AV1 y cumplir con el objetivo crítico del hito: el despliegue exitoso de la primera versión del Backend, Frontend Web, Mobile y Landing Page para la Semana 7. |
